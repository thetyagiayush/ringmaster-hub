...
const CostAnalyticsManager = () => {
  ...
  const fetchCostBreakdown = async () => {
    ...
    setError(null);
    try {
      const response = await axios.post('https://nytwilio-backend-main-app.vercel.app/api/v1/calling/get-cost-breakdown', {
  ...
  const updateBudget = async () => {
    ...
    try {
      const response = await axios.post('https://nytwilio-backend-main-app.vercel.app/api/v1/calling/update-budget', {
