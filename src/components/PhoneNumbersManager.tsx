...
export function PhoneNumbersManager() {
  ...
  const getAllNumbersHere = async () => {
    const res = await axios.get('http://localhost:6970/api/v1/calling/get-all-numbers');
  ...
  const handleAddNumber = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        "http://localhost:6970/api/v1/calling/add-number",
        formDataObj,
        {
          headers: {
  ...
  const handleUpdateText = async () => {
    ...
    try {
      const response = await axios.put(
        `http://localhost:6970/api/v1/calling/update-text/${editingNumber.id}`,
  ...
  const handleReplaceAudio = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `http://localhost:6970/api/v1/calling/update-audio/${editingNumber.id}`,
        formDataObj,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const handleDeleteNumber = async (number: NumberMapping) => {
    ...
    try {
      const response = await axios.delete(
        `http://localhost:6970/api/v1/calling/delete-number/${number.id}`
      );
  ...
  const handleConfigureWebhook = async (number: NumberMapping) => {
    ...
    try {
      const response = await axios.post(
        'http://localhost:6970/api/v1/calling/configure-webhook',
