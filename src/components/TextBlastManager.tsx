...
export function TextBlastManager() {
  ...
  const fetchCallLogs = async () => {
    ...
    try {
      const response = await axios.get('https://nytwilio-backend-main-app-zeta.vercel.app/api/v1/calling/get-logs');
  ...
  const handleSendBlast = async () => {
    ...
    try {
      for (let i = 0; i < batches.length; i++) {
        ...
        const response = await axios.post('https://nytwilio-backend-main-app-zeta.vercel.app/api/v1/calling/send-blast', {
